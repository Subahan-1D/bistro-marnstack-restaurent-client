...
const Navbar = () => {
  ...
  const navLinks = (
    <>
      ...
      {user && isAdmin && (
        <li>
          <Link to="/dashboard/adminHome" className="text-2xl ml-5">
            Dashboard
          </Link>
        </li>
      )}
      {user && !isAdmin && (
        <li>
          <Link to="/dashboard/userHome" className="text-2xl ml-5">
            Dashboard
          </Link>
        </li>
      )}
  ...
  return (
    <>
      <div className="navbar fixed z-10 bg-opacity-30 max-w-screen-xl bg-gray-900 lg:text-white md:text-white sm:text-black">
        <div className="navbar-start">
          ...
          <Link to="/" className=" uppercase ml-5  text-2xl font-lato">
            <h1 className="sm:text-green-500 md:text-orange-600 lg:text-yellow-400">
